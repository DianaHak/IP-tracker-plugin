...
class DIA_IPG_Admin {
  ...
  public static function handle_action() {
    ...
    if (!in_array($return_tab, ['overview', 'recent', 'notes', 'blocked', 'settings', 'info'], true)) {
      $return_tab = 'overview';
    }
        ...
        <table class="form-table" role="presentation">
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" style="margin-top:6px;">
                ...
                Smaller values keep your database lighter. A good default is <strong>7–30 days</strong>.
              </p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" style="margin-top:6px;">
                <strong>Enabled:</strong> visits from logged-in users will be logged.
                <br />
