...
class DIA_IPG_Admin
{
  ...
  public static function init()
  {
    ...
    add_action('admin_post_dia_ipg_reset_settings', [__CLASS__, 'reset_settings']);
...
public static function clear_logs() {
  ...
  global $wpdb;
  $table = $wpdb->prefix . 'dia_ipg_logs';
  $wpdb->query("TRUNCATE TABLE {$table}");

  wp_redirect(admin_url('admin.php?page=dia-ip-guardian&tab=settings'));
  exit;
}
...
public static function reset_settings() {
  ...
  // Delete your plugin options here
  delete_option('dia_ipg_retention_days');
  delete_option('dia_ipg_geo_enabled');
  delete_option('dia_ipg_whatever_else');
  ...
  private static function render_tab_settings(array $cfg, string $nonce): void
  {
    ...
    <div style="max-width: 900px;">
      <p>
        Here you can control how IP Guardian detects visitor IPs, how long logs are stored, and how country flags are
        detected.
        ...
        <table class="form-table" role="presentation">
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" style="margin-top:6px;">
                How long visit logs are kept before old entries are deleted automatically.
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" style="margin-top:6px;">
                <strong>enabled:</strong> visits made by Administrator users won’t be logged.
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" style="margin-top:6px;">
                <strong>enabled:</strong> visits from logged-in users (customers, editors, subscribers, etc.) will be
                logged.
                <br />
                <strong>disabled:</strong> only visitors who are not logged in will be tracked.
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" style="margin-top:6px;">
                Country detection is used only to show flags / country codes in the admin tables.
                If you don’t need flags, you can turn this off.
              </p>

              <ul style="margin:8px 0 0 18px; list-style:disc;">
                <li><strong>Auto:</strong> Best effort and easiest. Uses Cloudflare if available, otherwise tries MaxMind,
                  then remote API.</li>
                ...
                <li><strong>Remote API:</strong> Uses an external service to detect the country (works anywhere, but depends
                  on the vendor and network).</li>
              </ul>
              ...
              <p class="description" style="margin-top:6px;">
                <strong>enabled:</strong> the admin screen is allowed to request country info from the selected remote
                vendor,
                and results are cached so you don’t call the API again for the same IP.
                <br />
                <strong>disabled:</strong> no remote lookups will be made from wp-admin.
              </p>
              ...
              <p class="description" style="margin-top:6px;">
                ...
                This is only used if Geo detection is set to <strong>Auto</strong> (fallback) or <strong>Remote
                  API</strong>.
              </p>
  ...
  private static function render_tab_info(): void
  {
    ...
    <p>
  This plugin helps you see who is visiting your website and gives you simple tools to protect it.
</p>
...
<ul style="list-style: disc; padding-left: 18px;">
  ...
  <li>Helps you detect suspicious or unwanted bots based on traffic behavior</li>
  ...
  <li>Optionally detects visitor country (via Cloudflare, MaxMind, or remote API) and shows country flags</li>
    ...
    <div style="color: darkgrey; font-size: 11px;margin-top: 20px; border:1px solid #ddd; padding:12px; border-radius:4px;">
      ...
      <p style="max-width: 900px;">
        This plugin stores visitor IP addresses and related visit information. In many countries (including the EU and UK),
        IP addresses may be considered personal data under privacy laws like GDPR.
      </p>
      <p style="max-width: 900px;">
        If you use IP logging, you should mention it in your website’s Privacy Policy. Explain what data is collected (IP
        address, visited URL, browser information), why it is collected (security, analytics, abuse prevention), and how
        long it is stored.
      </p>
      <p style="max-width: 900px;">
